...
class UserFirestore{
  static final _firestoreInstane = FirebaseFirestore.instance;
  static final CollectionReference users = _firestoreInstane.collection('users');
  ...
  static Future<Map<String, Account>?> getPostUserMap(List<String> accountIds) async{
    ...
    try{
      ...
      print('それぞれのユーザー情報取得完了');
      return map;
    } on FirebaseException catch(e){
      print('それぞれのユーザー情報取得エラー');
      return null;
    }
  }
